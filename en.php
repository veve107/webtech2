...
$lang = array(
    ...
    "zadanie2" => "Show results",
    "zadanie3" => "Import results",
    "zadanie4" => "Delete results",
    "zadanie5" => "Team points",
    "zadanie6" => "Upload CSV",
    "zadanie7" => "Export CSV",
    "zadanie8" => "Read CSV",
    ...
    "plain" => "Plain Text",
    "html" => "HTML Template",
    "subjectMail" => "Subject of the mail",
    "attachment" => "Attachment",
    "filename" => "Filename",
    "download" => "Download",
    "default_select" => "Select from list",
    ...
    "approval" => "Approval",
    "agree" => "I agree",
    "notagree" => "I not agree",
    "close" => "Close",
    "choice" => "Really?",
    "change" => "It is unchangealble!",
